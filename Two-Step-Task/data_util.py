...
class DataProcessor(object):
    ...
    def create_hdf5raw(self, behavior_shape, neuron_shape, suffix=''):
        ...
        self.validation_brief_file = open(
            self.log_path + self.log_name + suffix + '-' + self.task_name + '.validation_brief.csv', 'w')
        ...
        self.raw_hdf5file = tables.open_file(self.log_path + self.log_name + suffix + '-' + self.task_name + '.hdf5',
                                             mode='w')
        ...
        self.behavior_storage = self.raw_hdf5file.create_earray(self.raw_hdf5file.root, 'behavior', content_type,
                                                                shape=behavior_shape)
        self.prediction_storage = self.raw_hdf5file.create_earray(self.raw_hdf5file.root, 'prediction', content_type,
                                                                  shape=behavior_shape)
        self.rawoutput_storage = self.raw_hdf5file.create_earray(self.raw_hdf5file.root, 'rawoutput', content_type,
                                                                 shape=behavior_shape)
        self.neuron_storage = self.raw_hdf5file.create_earray(self.raw_hdf5file.root, 'neuron', content_type,
                                                              shape=neuron_shape)
        self.index_storage = self.raw_hdf5file.create_earray(self.raw_hdf5file.root, 'index', index_dtype,
                                                             shape=label_shape)
    ...
    def save_condition(self, model_params, task_setting, training_file, validation_file):
        ...
        self.params = {
            ...
            "training": task_setting["need_train"],
            "validate": task_setting["need_validate"],
