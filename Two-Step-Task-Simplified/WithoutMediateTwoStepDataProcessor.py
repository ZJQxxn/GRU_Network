...
class WithoutMediateTwoStepDataProcessor(DataProcessor):
    '''
    Decription: 
    ...
    def __init__(self, train_data_file, validate_data_file):
        ...
        '''
        super(WithoutMediateTwoStepDataProcessor, self).__init__()
    ...
    def prepareTrainingData(self):
        ...
        self.train_data_set = [t[0] for t in mat['data_RL']]
        self.train_guide = mat['data_RL_Brief']['training_guide'][0][0]
    ...
    def prepareValidatingData(self):
        ...
        self.validate_data_set = [t[0] for t in mat['data_RL']]
        self.validate_data_attr = mat['data_RL_Brief']
        return self.validate_data_set, self.validate_data_attr


if __name__ == '__main__':
    p = WithoutMediateTwoStepDataProcessor('./data/SimpTwo_TrainingSet-2019_11_19-1.mat',
