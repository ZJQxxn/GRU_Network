...
filename = 'RewardAffectData-OldTraining-OldNetwork-ThreeArmed-sudden-reverse-model1-validation-1e6.hdf5'
...
for whole_blk_index in range(numWholeBlocks - 1):
    ...
    cr = [
        ...
        # 1 if choices[trial] == block_indication[trial] # choice is 1/2/3, indicator is 1/2/3
        else 0
    ...
    random_cr = [
        ...
        # 1 if random_choice[trial] == block_indication[trial] # choice is 1/2/3, indicator is 1/2/3
        else 0
        for trial in cr_range
    ]
