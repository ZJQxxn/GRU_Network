...
if __name__ == '__main__':
    analyzer = TaskAnalyzer(
        'RewardAffectData-OldTraining-OldNetwork-ThreeArmed-slow-reverse-model1-validation-1e6.hdf5',
        'RewardAffectData-OldTraining-OldNetwork-ThreeArmed-slow-reverse-model2-validation-1e6.hdf5',
        'RewardAffectData-OldTraining-OldNetwork-ThreeArmed-slow-reverse-model3-validation-1e6.hdf5',
