...
if __name__ == '__main__':
    analyzer = TaskAnalyzer('RandomChoice-ThreeArmed-slow-reverse-validation-1e6.hdf5',
                            './data/RandomChoice_ThreeArmed_TestingSet-2020_07_23-blk70-reverseblk5-noise-1.mat',
                            block_size = 70)
