...
filename = 'MyCode-two_step_without_intermediate-new-validation.hdf5' # trans_prob = 0.8, without B
# filename = 'SeqCode-20200210_1310-revrl_lr.hdf5' # less time steo; does not show choices
