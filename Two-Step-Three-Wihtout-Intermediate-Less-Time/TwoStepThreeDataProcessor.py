...
class TwoStepThreeDataProcessor(DataProcessor):
    '''
    Decription: 
    ...
    def __init__(self, train_data_file, validate_data_file):
        ...
        '''
        super(TwoStepThreeDataProcessor, self).__init__()
...
if __name__ == '__main__':
    p = TwoStepThreeDataProcessor('./data/SimpTwo_TrainingSet-2019_11_19-1.mat',
